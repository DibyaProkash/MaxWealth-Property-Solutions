...
export default function CalculatorsSection() {
  ...
  const BetaDisclaimer = () => (
    <div className="mt-10 p-4 bg-destructive/10 border border-destructive/30 rounded-lg text-sm text-destructive flex items-start col-span-1 md:col-span-5">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="font-headline text-3xl md:text-4xl font-bold text-primary mb-4">
            Financial Tools, AI Insights & Readiness Quiz
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Empower your financial decisions with our suite of calculators, explore AI-powered insights, and assess your home buying readiness.
          </p>
        </div>

        <div className="grid md:grid-cols-5 gap-8 lg:gap-12">
          {/* Left Column: Calculators and AI Text Tools */}
          <div className="md:col-span-3 space-y-12">
            ...
            <div className="space-y-8">
              <h3 className="font-headline text-2xl md:text-3xl font-bold text-primary text-center">
          ...
          <div className="md:col-span-2">
            <div className="sticky top-24"> {/* Make quiz sticky on larger screens */}
              <h3 className="font-headline text-2xl md:text-3xl font-bold text-primary mb-6 text-center">
                Home Buying Readiness Quiz
              </h3>
              <QuizSection />
