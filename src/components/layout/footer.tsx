...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-border/40 bg-background/95 text-foreground"> {/* Ensure text is readable */}
      <div className="container mx-auto py-8 px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <Briefcase className="h-8 w-8 text-primary" /> {/* Primary color for icon */}
          ...
          <div>
            <h3 className="font-headline text-lg font-semibold mb-3 text-primary">Quick Links</h3> {/* Primary color for heading */}
            <ul className="space-y-2 text-sm">
              <li><a href="#about" className="text-muted-foreground hover:text-primary transition-colors">About Us</a></li>
              <li><a href="#content" className="text-muted-foreground hover:text-primary transition-colors">Insights</a></li>
          ...
          <div>
            <h3 className="font-headline text-lg font-semibold mb-3 text-primary">Connect With Us</h3> {/* Primary color for heading */}
